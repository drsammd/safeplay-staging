...
import { User, Heart, Camera, Settings, LogOut, Menu, X, Home, Smartphone, BookOpen, MessageCircle, CreditCard, Tag } from "lucide-react";
...
export default function ParentLayout({ children }: ParentLayoutProps) {
  ...
  const navigation = [
    ...
    { name: "Mobile App", href: "/parent/mobile", icon: Smartphone },
    { name: "Account", href: "/parent/account", icon: User },
    { name: "Documentation", href: "/docs", icon: BookOpen },
  ];

  return (
    <div className="min-h-screen bg-parent bg-overlay-light">
