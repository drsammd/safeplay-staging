          ...
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center">
              <Image 
                ...
                alt="mySafePlay™ - Biometric Child Safety Platform" 
                width={120} 
                height={40}
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Get answers to common questions about mySafePlay™'s biometric child safety technology, 
          ...
          <Accordion type="single" collapsible className="space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-8">
              ...
              <AccordionItem value="age-range" className="border-b border-gray-200">
                ...
                <AccordionContent className="text-gray-600 pt-4">
                  mySafePlay™ is designed for children aged 2-16 years. Our facial recognition technology is optimized to work accurately with children's faces as they grow and change. The system learns and adapts to recognize children even as they age, ensuring consistent protection throughout their childhood.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="check-in-process" className="border-b border-gray-200">
                ...
                <AccordionContent className="text-gray-600 pt-4">
                  mySafePlay™ uses a simple QR code system for check-in and check-out. Each family receives a unique QR code that can be scanned at the venue entrance. The system automatically recognizes your child through facial recognition and confirms their identity. You can also use the mobile app to check in multiple children at once and receive instant confirmation when they're safely in the venue.
                </AccordionContent>
              </AccordionItem>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-8">
              ...
              <AccordionItem value="photo-copies" className="border-b border-gray-200">
                ...
                <AccordionContent className="text-gray-600 pt-4">
                  Yes! When other families capture photos that include your child, you can request copies through the mySafePlay™ app. The system automatically identifies your child in photos and notifies you when new photos are available. Other families can approve or share these photos with you, creating a collaborative approach to capturing memories.
                </AccordionContent>
              </AccordionItem>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-8">
              ...
              <AccordionItem value="find-child" className="border-b border-gray-200">
                ...
                <AccordionContent className="text-gray-600 pt-4">
                  mySafePlay™'s enhanced navigation system provides real-time location tracking and optimal pathfinding to help you locate your child quickly. The mobile app shows your child's current location, suggests the best route to reach them, and considers crowd density to avoid congested areas. You'll also receive notifications when your child moves to different zones within the venue.
                </AccordionContent>
              </AccordionItem>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-8">
              ...
              <AccordionItem value="lost-qr-code" className="border-b border-gray-200">
                ...
                <AccordionContent className="text-gray-600 pt-4">
                  No problem! You can access your QR code anytime through the mySafePlay™ mobile app, email, or by providing identification at the venue. Venue staff can also verify your identity through the system and provide temporary access. For added security, QR codes can be regenerated instantly if needed, and the old codes are automatically deactivated.
                </AccordionContent>
              </AccordionItem>
